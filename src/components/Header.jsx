...
const Header = () => {
    ...
    return(
        <div className="sticky w-100 border-bottom" style={{ zIndex: 3 }} id="header">
            ...
            <nav className="navbar navbar-expand-lg navbar-light justify-content-between" style={{transition : '0.2s ease-in-out'}}>

                <a href="/" className='navbar-brand'>
                    <img src={logo} width='120vw' alt="" />
                </a>

                <button className="navbar-toggler mr-3" onClick={toggleNavbarBg}  data-toggle='collapse' data-target='#navigation' aria-controls='navigation' aria-expanded='false' aria-label='Toggle Navigation'>
